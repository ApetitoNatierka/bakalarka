...
@section('content')
    ...
    <link href="{{ asset('css/styles_company_profile.css.css') }}" rel="stylesheet">
    <div class="container">
                ...
                <div class="card p-3">
                    <div class="row mb-3">
                        <div class="col">
                            ...
                            @if(auth()->id() !== null)
                                <input type="text" class="form-control col custom-input" id="name" name="name" value="{{ $copany->name }}">
                            @else
